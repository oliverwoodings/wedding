  ...
  return (
    ...
    >
      ...
      <Block header='Accomodation'>
        <P>Ringmore itself has very limited accomodation, so we advise looking slightly further afield. The villages of Challaborough, Kingston, Modbury, Bigbury and St. Ann's Chapel are all within a 10 minute drive. If you are looking for a larger town to base yourself in then Kingsbridge or Ivybridge are both lovely. You can find holiday cottages, BnBs and hotels in all of these places via websites such as <Link href='https://www.airbnb.co.uk/'>Airbnb</Link> and <Link href='https://www.booking.com/'>Booking.com</Link>.</P>
      ...
      <Block header='On the day'>
        ...
        {!user.eveningOnly && <P>All activities for the day are based within Ringmore in easy walking distance, so no need to worry about taxis to the reception!</P>}
      </Block>
      <Block header='Map'>
        <iframe
