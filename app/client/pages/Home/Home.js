...
export default function Home ({ user }) {
  return (
    <PageBody title={`Hello ${hello(user.guests)}!`} className={styles.home}>
      <P>You are invited to join us at our wedding on the 27th of July 2019! The big day will be taking place in the lovely village of <Link href='http://www.ringmore.info/'>Ringmore, South Devon</Link>.</P>
      ...
      <P>If you have any questions, please don't hesitate to get in contact via <Link href='mailto:hello@danniandoli.wedding'>email</Link> or any other method you prefer.</P>
